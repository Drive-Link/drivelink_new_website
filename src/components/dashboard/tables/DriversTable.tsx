...
import { MoreHorizontal, Star, ChevronLeft, ChevronRight, Plus } from "lucide-react"

const drivers = [
  {
    id: 1,
    name: "Goodluck Richards",
  ...
  return (
    <div className="bg-white rounded-xl shadow">
      ...
      <div className="hidden lg:block">
        <Table aria-label="Drivers table" selectionMode="none"
          bottomContent={
        ...
        >
          ...
          <TableBody>
            {drivers.map((driver) => (
              <TableRow key={driver.id} className="border-b border-b-gray-100">
                <TableCell>
                  <div className="flex items-center gap-3">
                    <Avatar name={driver.name.slice(0, 1)}
