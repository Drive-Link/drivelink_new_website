...
const HeroSection = () => {
  return (
    <div className="hero-section bg-[rgba(235,241,255,0.6)] ">
      <div className="hero-section-content max-w-[1200px] mx-auto min-h-[80vh] pb-[10px] px-[20px] sm:px-[0px] pt-[50px] ">
        {/* h1 */}
        <div className="h1 flex justify-center   ">
          <span className='text-[30px] leading-[40px] font-[700] max-w-[400px] text-center ' >
          Find and Hire Verified Drivers 
          <span className='text-[#101F91] ' > Fast and <br />  Hassle-Free</span>
          </span>
        </div>
        {/* p */}
        <div className="p flex justify-center mt-[20px] ">
          <p className='text-center text-[#828589] text-[18px] max-w-[400px] leading-[26px] font-[400] ' >
        ...
        {/* world-drivers */}
        <div className="world-drivers mt-[40px] flex justify-center relative z-[1]  ">
          <div className="img max-w-[400px] w-[100%] ">
